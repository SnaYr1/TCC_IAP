    ...
    <div class="container w3-center w3-padding">
        <div class="row ">
            <div class="col-md-4 col-md-offset-4  w3-content">
                <div class="login-panel panel panel-default w3-padding" style="border: 1px solid lightgrey;border-radius:10px;">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="post" action="" role="form">
                                ...
                                <div class="form-group">
                                    <input class="" required placeholder="Senha" name="password" type="password" >
                                </div>
