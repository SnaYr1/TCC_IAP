    ...
    <div class="section">
      <div class="row">
        <div class="col-md-6 col-xs-6">
          <ul>
            <li><h2 class="w3-text-black" data-toggle="collapse" data-target="#demo"><a> Neuro-estimulação </a></h2></li>
              <div id="demo" class="collapse">
                Lsssssssssss
                <hr>
              </div>
              
            <li><h2 class="w3-text-black" data-toggle="collapse" data-target="#demo1"><a>Terapêutica Multidisciplinar </a></h2></li>
              <div id="demo1" class="collapse">
                aaaaaaaaaaaa
                <hr>
              </div>
            <li><h2 class="w3-text-black" data-toggle="collapse" data-target="#demo2"><a> Atendimento Psicológicos </a></h2></li>
        ...
        <div class="col-md-6 col-xs-6">
          <ul>
            <li><h2 class="w3-text-black" data-toggle="collapse" data-target="#demo3"><a> Atividade física adaptada </a></h2></li>
              <div id="demo3" class="collapse">
                Lsssssssssss
                <hr>
              </div>
            <li><h2 class="w3-text-black" data-toggle="collapse" data-target="#demo4"><a>Oficina para idosos </a></h2></li>
              <div id="demo4" class="collapse">
                aaaaaaaaaaaa
                <hr>
              </div>
            <li><h2 class="w3-text-black" data-toggle="collapse" data-target="#demo5"><a> Atendimento Domiciliar </a></h2></li>
